...
export default function Contact() {
  ...
  return (
    <article className=" flex flex-col items-center justify-between px-5 text-center gap-10 py-12 w-[375px]">
      ...
      <section className="flex flex-col items-center justify-between w-full px-3 gap-10 py-10">
        <h2 className="text-[#36536B] text-[24px] font-normal left-8 tracking-[-0.185px] opacity-70">
